...
def _gemini_model():
    ...
    # a secrets update, not a code change. Google has deprecated models
    # fast: gemini-1.5-flash (Sept 2025) and gemini-2.5-flash (no longer
    # available to new users as of this writing) are both dead — do not
    # revert to either. Prefer overriding GEMINI_MODEL in secrets.toml
    # directly over relying on this default, since it will go stale again.
